...
<body>
  <?php 
  if(isset($_GET['status'])) echo "<script>alert('ban da tao thanh cong');</script>";
  if(isset($_GET['edit_status'])) echo "<script>alert('ban da sua thanh cong');</script>";
  ...
  <div class="container">
    ...
    <form action="" method="POST" name="myform2">
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-4">
          <input type="text" name="urlimg" class=" form-control form-control-lg" id="colFormLabelLg"
            placeholder="URL hình ảnh cửa hàng">
        </div>
      </div>
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-4">
          <input type="text" name="urlweb" class="form-control form-control-lg" id="colFormLabelLg"
            placeholder="link website cửa hàng">
        </div>
      </div>
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-4">
          <input type="text" name="urlfb" class="form-control form-control-lg" id="colFormLabelLg"
            placeholder="Link fan page website">
      ...
      <input type="hidden" name="tinhthanh" value="<?php echo $tinhthanh; ?>">
    ...
    if(isset($_POST['submit'])){
      ...
      $query="insert into wp_he_thong_ch values(NULL,'$urlimg','$namestore','$urlweb','$address_store','$sdt','$urlfb','$urlggm','$tinhthanh')";
      if(mysqli_query($link, $query)){
        header('Location: http://localhost/codenap/addstore.php?status=success');
      }
      else{
        echo $query;
      }
  ...
  <div>
    <table>
      ...
      <?php 
          $query3='select * from wp_he_thong_ch';
          $result3 = mysqli_query($link, $query3);
          while($arr = mysqli_fetch_array($result3)){
        ?>
      <tr>
        ...
        <td>
          <?php echo $arr['facebook_url']?>
        </td>
        <td>
          <?php echo $arr['map_url']?>
        </td>
        <td>
